...
const { allusres, createuser , verifyuser , upload  } = require("../controller/jobportalsupport.controller");
...
jobportalsupportRoute.post("/register",upload.single("img"),bodychecker,createuser); // in this route will be use recaptcha 
